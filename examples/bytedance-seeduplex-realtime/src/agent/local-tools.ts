...
export const TOOL_SAVE_CALLER_NAME: LocalFunctionTool = {
    type: 'function',
    function: {
...
export const TOOL_SAVE_CALLER_COMPANY: LocalFunctionTool = {
    type: 'function',
    function: {
...
export const TOOL_SAVE_CALLER_REASON: LocalFunctionTool = {
    type: 'function',
    function: {
...
export const TOOL_TRANSFER_CALL: LocalFunctionTool = {
    type: 'function',
    function: {
        name: 'transfer_call',
...
export const TOOL_DROP_CALL: LocalFunctionTool = {
    type: 'function',
    function: {
        name: 'drop_call',
...
export const TOOL_TRANSFER_TO_VOICEMAIL: LocalFunctionTool = {
    type: 'function',
    function: {
...
export function buildLocalTools(opts?: { callScreening?: boolean }): LocalFunctionTool[] {
